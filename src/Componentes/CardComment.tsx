...
function Card4({ comentario }: { comentario: Comentario }) {
  ...
  return (
    ...
    <div className="card card-opiniones">
      ...
      <div className="card-body cuerpo-opiniones">
      <div >
        <img className="thumbnail-producto" src={comentario.foto} alt={comentario.autor} />
      </div>
        <div className="card-title titulo-opinion">
          <div className="titulo">{comentario.autor} </div>
        </div>

        <div className='row contenido-tarjeta'>

          <div className='col-12'>
            <Rating value={comentario.valoracion} />
          </div>
          <div className="card-text desc" style={{ height: '90px' }}>

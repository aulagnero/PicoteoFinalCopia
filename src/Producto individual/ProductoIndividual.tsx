          ...
          <div className="row g-0 ">
            <div className="col-6 fila-principal">
              <div className=" col-2 thumbnails">
                {product.imagen.map((image: string, index: number) => (
              ...
              <div className="col-md-4 imagen-principal">
                <img src={selectedImage} className="img-fluid rounded-start imagen-grande" alt={product.nombre} />
              </div>
            </div>
            ...
            <div className="col-md-6">
              <div className="row">
                ...
                <div className="descripcion-producto">{product.descripcion}</div>
                <div className="descripcion-producto">{product.categoria}</div>
